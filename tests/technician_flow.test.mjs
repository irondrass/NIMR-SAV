...
assert.equal(appVersion, 'v22.25', 'APP_VERSION doit rester en v22.25 pour cette branche');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=22\.25"/, 'le service worker doit être enregistré avec sw.js?v=22.25');
