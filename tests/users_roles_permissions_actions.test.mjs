...
assert.match(stateSource, /APP_VERSION\s*=\s*"v23\.1\.2"/, 'APP_VERSION doit rester en v23.1.2 pour cette branche');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=23\.1\.2"/, 'le service worker doit pointer vers sw.js?v=23.1.2');
assert.match(swSource, /nimr-sav-v23\.1\.2-reception-workspace-claims/, 'le cache PWA doit refléter v23.1.2');
