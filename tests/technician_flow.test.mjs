...
assert.equal(appVersion, 'v23.0', 'APP_VERSION doit rester en v23.0 pour cette branche');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=23\.0"/, 'le service worker doit être enregistré avec sw.js?v=23.0');
