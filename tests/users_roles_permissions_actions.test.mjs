...
assert.match(stateSource, /APP_VERSION\s*=\s*"v22\.35"/, 'APP_VERSION doit rester en v22.35 pour cette branche');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=22\.35"/, 'le service worker doit pointer vers sw.js?v=22.35');
assert.match(swSource, /nimr-sav-v22\.35-production-audit-hardening/, 'le cache PWA doit refléter v22.35');
