...
assert.equal(appVersion, 'v22.26', 'APP_VERSION doit rester en v22.26 pour cette branche');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=22\.26"/, 'le service worker doit être enregistré avec sw.js?v=22.26');
