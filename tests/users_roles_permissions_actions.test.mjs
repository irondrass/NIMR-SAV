...
assert.match(stateSource, /APP_VERSION\s*=\s*"v22\.32"/, 'APP_VERSION doit rester en v22.33');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=22\.32"/, 'le service worker doit pointer vers sw.js?v=22.33');
assert.match(swSource, /nimr-sav-v22\.32-activity-log-settings-patch/, 'le cache PWA doit refléter v22.33');
