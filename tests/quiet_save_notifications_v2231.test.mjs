...
assert.match(stateJs, /APP_VERSION\s*=\s*"v23\.0\.3"/, "state.js n'a pas la bonne version");
assert.match(swJs, /nimr-sav-v23\.0\.3-role-access-dom-scrub/, "sw.js n'a pas le bon cache");
assert.match(versionJs, /NIMR_BUILD\s*=\s*"v23\.0\.3"/, "version.js n'a pas la bonne version");
assert.match(appJs, /sw\.js\?v=23\.0\.3/, "app.js n'appelle pas le bon sw.js");
