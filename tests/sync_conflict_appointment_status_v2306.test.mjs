...
console.log("Démarrage tests statut RDV canonique sync v23.2.0...");
...
// 13. Version/cache v23.2.0 validés
{
  ...
  assert.match(swSource, /nimr-sav-v23\.2\.0-sav-performance-dashboard/, "sw.js n'a pas le bon cache");
  ...
  console.log("-> Test 13 (Version/cache v23.2.0) OK");
}

console.log("Tous les tests statut RDV canonique sync v23.2.0 passés avec succès !");
