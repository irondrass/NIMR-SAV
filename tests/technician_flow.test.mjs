...
assert.equal(appVersion, 'v22.24', 'APP_VERSION doit rester en v22.24 pour cette branche');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=22\.24"/, 'le service worker doit être enregistré avec sw.js?v=22.24');
