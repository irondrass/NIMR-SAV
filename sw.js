const CACHE_NAME = "nimr-sav-v23.3.2";
const ASSETS = [
  "./",
  "./index.html",
  "./offline.html",
  ...
  "./js/version.js?v=23.3.2",
  "./supabase-schema.sql",
  "./assets/icon.svg",
  "./assets/icon-192.png",
  "./assets/icon-512.png",
  "./assets/apple-touch-icon.png",
  "./vendor/pdf.min.js?v=23.3.2",
  "./vendor/pdf.worker.min.js?v=23.3.2",
  "./js/utils.js?v=23.3.2",
  "./js/state.js?v=23.3.2",
  "./js/ui-cases.js?v=23.3.2",
  "./js/estimate-import.js?v=23.3.2",
  "./js/ui-planning.js?v=23.3.2",
  "./js/photos.js?v=23.3.2",
  "./js/storage.js?v=23.3.2",
  "./js/work-hours-sync.js?v=23.3.2",
  "./js/planning.js?v=23.3.2",
  "./js/exports.js?v=23.3.2",
  "./js/business-rules-v2187.js?v=23.3.2",
  "./js/supabase-config.js?v=23.3.2",
  "./js/supabase-client.js?v=23.3.2",
  "./js/supabase-sync.js?v=23.3.2",
];
