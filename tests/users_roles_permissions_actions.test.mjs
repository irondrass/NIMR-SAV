...
assert.match(stateSource, /APP_VERSION\s*=\s*"v22\.28"/, 'APP_VERSION doit rester en v22.28');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=22\.28"/, 'le service worker doit pointer vers sw.js?v=22.28');
assert.match(swSource, /nimr-sav-v22\.28-dynamic-dependent-reschedule/, 'le cache PWA doit refléter v22.28');
