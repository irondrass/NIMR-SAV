const CACHE_NAME = "nimr-sav-v23.3.4";
const ASSETS = [
  "./",
  "./index.html",
  "./offline.html",
  ...
  "./js/version.js?v=23.3.4",
  "./supabase-schema.sql",
  "./assets/icon.svg",
  "./assets/icon-192.png",
  "./assets/icon-512.png",
  "./assets/apple-touch-icon.png",
  "./vendor/pdf.min.js?v=23.3.4",
  "./vendor/pdf.worker.min.js?v=23.3.4",
  "./js/utils.js?v=23.3.4",
  "./js/state.js?v=23.3.4",
  "./js/ui-cases.js?v=23.3.4",
  "./js/estimate-import.js?v=23.3.4",
  "./js/ui-planning.js?v=23.3.4",
  "./js/photos.js?v=23.3.4",
  "./js/storage.js?v=23.3.4",
  "./js/work-hours-sync.js?v=23.3.4",
  "./js/planning.js?v=23.3.4",
  "./js/exports.js?v=23.3.4",
  "./js/business-rules-v2187.js?v=23.3.4",
  "./js/supabase-config.js?v=23.3.4",
  "./js/supabase-client.js?v=23.3.4",
  "./js/supabase-sync.js?v=23.3.4",
];
