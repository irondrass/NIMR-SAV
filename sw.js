const CACHE_NAME = "nimr-sav-v23.3.3";
const ASSETS = [
  "./",
  "./index.html",
  "./offline.html",
  ...
  "./js/version.js?v=23.3.3",
  "./supabase-schema.sql",
  "./assets/icon.svg",
  "./assets/icon-192.png",
  "./assets/icon-512.png",
  "./assets/apple-touch-icon.png",
  "./vendor/pdf.min.js?v=23.3.3",
  "./vendor/pdf.worker.min.js?v=23.3.3",
  "./js/utils.js?v=23.3.3",
  "./js/state.js?v=23.3.3",
  "./js/ui-cases.js?v=23.3.3",
  "./js/estimate-import.js?v=23.3.3",
  "./js/ui-planning.js?v=23.3.3",
  "./js/photos.js?v=23.3.3",
  "./js/storage.js?v=23.3.3",
  "./js/work-hours-sync.js?v=23.3.3",
  "./js/planning.js?v=23.3.3",
  "./js/exports.js?v=23.3.3",
  "./js/business-rules-v2187.js?v=23.3.3",
  "./js/supabase-config.js?v=23.3.3",
  "./js/supabase-client.js?v=23.3.3",
  "./js/supabase-sync.js?v=23.3.3",
];
