...
assert.match(stateSource, /APP_VERSION\s*=\s*"v22\.21"/, 'APP_VERSION doit être en v22.21');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=22\.21"/, 'le service worker doit pointer vers sw.js?v=22.21');
