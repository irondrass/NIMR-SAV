...
// AUDIT-UX source refresh: atomic worker-aligned release v23.3.35 with reliable operational decisions and role-focused workshop flow.
// FIELD-AUDIT source refresh: atomic worker-aligned release v23.3.36 with robust field PDF import and canonical technician linking.
// WORK-AUTHORIZATION-001 source refresh: atomic worker-aligned release v23.3.37 with explicit evidence-backed work authorization.
// OFFLINE-AUTH-001 source refresh: atomic worker-aligned release v23.3.38 with transport-aware auth startup.
// SUPPLEMENT-FORM-DRAFT-001: v23.3.42 preserve unsaved supplement drafts across case detail rerenders.
// VN-PART-003B source refresh: atomic worker-aligned release v23.3.43 with read-only donor dashboard and fail-closed workshop context.
// VN-PART-003C source refresh: atomic worker-aligned release v23.3.44 with controlled mutation workflows.
// VN-PART-EMPTY-LIST source refresh: atomic worker-aligned release v23.3.46 with pre-removal request visibility before donor assignment.
// VN-PART-004 source refresh: atomic worker-aligned release v23.3.47 with donor intelligence and projected restoration ETA.
// VN-PART-006 source refresh: atomic worker-aligned release v23.3.50 with physical removals XLSX export and Director deletion.
// PREL-AUDIT-CORR-001 source refresh: atomic worker-aligned release v23.3.51 with hardened VN parts approval, store acknowledgement and traceability workflow.
// RECEPTION-R1-001 source refresh: atomic worker-aligned release v23.3.52 with Reception RBAC hardening and reception state consistency.
...
// CA-PLAN-001 source refresh: atomic worker-aligned release v23.3.54 with one internal technician per specialty per vehicle.
const CACHE_NAME = "nimr-sav-v23.3.54";
const ASSETS = [
  "./",
  "./index.html",
  "./offline.html",
  "./rescue.html",
  "./styles.css?v=23.3.54",
  "./app.js?v=23.3.54",
  "./manifest.webmanifest",
  "./js/version.js?v=23.3.54",
  "./supabase-schema.sql",
  "./assets/icon.svg",
  "./assets/icon-192.png",
  "./assets/icon-512.png",
  "./assets/apple-touch-icon.png",
  "./vendor/pdf.min.js?v=23.3.54",
  "./vendor/pdf.worker.min.js?v=23.3.54",
  "./vendor/xlsx.mini.min.js?v=23.3.54",
  "./js/utils.js?v=23.3.54",
  "./js/state.js?v=23.3.54",
  "./js/ui-cases.js?v=23.3.54",
  "./js/estimate-import.js?v=23.3.54",
  "./js/ui-planning.js?v=23.3.54",
  "./js/photos.js?v=23.3.54",
  "./js/storage.js?v=23.3.54",
  "./js/work-hours-sync.js?v=23.3.54",
  "./js/planning.js?v=23.3.54",
  "./js/exports.js?v=23.3.54",
  "./js/business-rules-v2187.js?v=23.3.54",
  "./js/supabase-config.js?v=23.3.54",
  "./js/supabase-client.js?v=23.3.54",
  "./js/supabase-sync.js?v=23.3.54",
  "./js/vn-part-client.js?v=23.3.54",
  "./js/vn-part-ui.js?v=23.3.54",
];
...
function isReleaseAsset(url) {
  try {
    ...
    return parsed.searchParams.get("v") === "23.3.54";
  } catch {
    return false;
  }
}
