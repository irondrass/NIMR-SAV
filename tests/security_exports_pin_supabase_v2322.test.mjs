...
console.log("Demarrage tests v23.2.4 security exports PIN and Supabase hardening...");
...
assert.match(stateSource, /APP_VERSION\s*=\s*"v23\.2\.4"/, "APP_VERSION v23.2.4 attendu");
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=23\.2\.4"/, "service worker v23.2.4 attendu");
assert.match(versionSource, /NIMR_CACHE_NAME\s*=\s*"nimr-sav-v23\.2\.4-sync-conflict-badge-usability-hotfix"/, "cache annonce v23.2.4 attendu");
assert.match(swSource, /nimr-sav-v23\.2\.4-sync-conflict-badge-usability-hotfix/, "cache PWA v23.2.4 attendu");
...
console.log("Tests v23.2.4 security exports PIN and Supabase hardening OK");
