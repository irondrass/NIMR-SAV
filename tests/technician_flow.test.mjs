...
assert.equal(appVersion, 'v22.29', 'APP_VERSION doit rester en v22.29 pour cette branche');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=22\.29"/, 'le service worker doit être enregistré avec sw.js?v=22.29');
