...
assert.match(stateSource, /APP_VERSION\s*=\s*"v23\.1A\.1"/, 'APP_VERSION doit être en v23.1A.1');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=23\.1A\.1"/, 'le service worker doit pointer vers sw.js?v=23.1A.1');
