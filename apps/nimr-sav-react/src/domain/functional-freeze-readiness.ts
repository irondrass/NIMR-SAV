...
// Historique : v24.0.0-alpha.15 a existé et a été validée techniquement mais a reçu un NO-GO terrain.
// alpha.14 est un retour en phase alpha de développement.
export const FUNCTIONAL_FREEZE_VERSION = 'v24.0.0-alpha.15' as const;
