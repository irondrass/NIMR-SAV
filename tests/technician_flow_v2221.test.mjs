...
assert.match(stateSource, /APP_VERSION\s*=\s*"v22\.22"/, 'APP_VERSION doit être en v22.22');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=22\.22"/, 'le service worker doit pointer vers sw.js?v=22.22');
