...
test("24 release identity stays v23.3.30", () => { assert.match(version,/^window\.APP_VERSION = "v23\.3\.30";$/mu); assert.match(version,/^window\.NIMR_BUILD = "v23\.3\.30";$/mu); assert.match(version,/^window\.NIMR_CACHE_NAME = "nimr-sav-v23\.3\.30";$/mu); });
