...
assert.match(stateSource, /APP_VERSION\s*=\s*"v23\.1\.3"/, 'APP_VERSION doit rester en v23.1.3 pour cette branche');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=23\.1\.3"/, 'le service worker doit pointer vers sw.js?v=23.1.3');
assert.match(swSource, /nimr-sav-v23\.1\.3-reception-create-case-local-pin-fix/, 'le cache PWA doit refléter v23.1.3');
