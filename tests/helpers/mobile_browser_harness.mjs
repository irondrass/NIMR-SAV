  ...
  return `(async () => {
    ...
    const makeCase = (id, plate, vehicle, workStarted) => ({
      ...
      claims: [{
        ...
        clientApproved: true,
        authorizationReference: "OR-" + id.toUpperCase(),
        authorizationAt: new Date(now.getTime() - 86400000).toISOString(),
        authorizationBy: "front",
    ...
    const makeBooking = (id, caseId, start, end, status, businessTaskId) => ({
      ...
      resourceIds: ["tech-mobile", "pont-mobile"], primaryResourceId: "tech-mobile", equipmentResourceIds: ["pont-mobile"],
