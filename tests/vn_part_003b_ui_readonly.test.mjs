...
test("10. PWA Precache: Both new JS files exist in sw.js ASSETS with exact release query", () => {
  ...
  assert.ok(
    indexHtmlContent.includes('<script src="js/vn-part-client.js?v=23.3.44" defer></script>'),
    "index.html must include vn-part-client.js with active query v=23.3.44"
  );
  assert.ok(
    indexHtmlContent.includes('<script src="js/vn-part-ui.js?v=23.3.44" defer></script>'),
    "index.html must include vn-part-ui.js with active query v=23.3.44"
  );
  ...
  assert.ok(
    assetsBlock.includes('"./js/vn-part-client.js?v=23.3.44"'),
    "sw.js ASSETS must precache ./js/vn-part-client.js?v=23.3.44"
  );
  assert.ok(
    assetsBlock.includes('"./js/vn-part-ui.js?v=23.3.44"'),
    "sw.js ASSETS must precache ./js/vn-part-ui.js?v=23.3.44"
  );

  // Assert version was bumped to v23.3.44
  assert.ok(
    swJsContent.includes('const CACHE_NAME = "nimr-sav-v23.3.44";'),
    "sw.js CACHE_NAME must be nimr-sav-v23.3.44"
  );
});
