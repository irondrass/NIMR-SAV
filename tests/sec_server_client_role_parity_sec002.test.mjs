...
// CHECK A: Release & Schema Baseline Constants
{
  ...
  assert.equal(ctx.APP_VERSION, "v23.3.16", "APP_VERSION must be v23.3.16");
  assert.equal(ctx.NIMR_BUILD, "v23.3.16", "NIMR_BUILD must be v23.3.16");
  assert.equal(ctx.NIMR_CACHE_NAME, "nimr-sav-v23.3.16", "NIMR_CACHE_NAME must be nimr-sav-v23.3.16");
