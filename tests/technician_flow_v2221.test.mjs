...
assert.match(stateSource, /APP_VERSION\s*=\s*"v22\.33"/, 'APP_VERSION doit être en v22.33');
assert.match(appSource, /serviceWorker\.register\("sw\.js\?v=22\.33"/, 'le service worker doit pointer vers sw.js?v=22.33');
